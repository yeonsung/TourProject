			...
			$('#passcheck').keyup(
					function() {
						if ($('#password').val() != $('#passcheck').val()) {
							$('#passcheckform').removeClass('has-success')
									.addClass('has-error').addClass(
											'has-feedback');
						} else {
							$('#passcheckform').removeClass('has-error')
									.addClass('has-success').addClass(
											'has-feedback').addClass(
											'glyphicon-ok');
						}
					});
		});
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<form class="form-horizontal" action="register.do" method="post"
					name="registerForm" id="registerFrm">
						...
						<div class="cols-sm-5">
							<div class="input-group">
								...
								<input type="text" class="form-control" name="id" id="id"
									...
									type="button" class="btn btn-primary btn-sm" value="중복확인">
							</div>
						</div>
					</div>
						...
						<div class="cols-sm-10">
							<div class="input-group">
								...
								<input type="password" class="form-control" name="confirm"
									id="passcheck" placeholder="비밀번호를 한번 더 입력하세요." required /> <span
						...
						<div class="cols-sm-10">
							<div class="input-group">
								...
								<input type="text" class="form-control" name="ssn" id="ssn"
									placeholder="주민등록번호를 입력하세요." required />
							</div>
						</div>
					</div>
