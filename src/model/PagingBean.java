...
public class PagingBean {
	...
	public int getTotalPage(){					//전체 페이지 수
	...
	public int getTotalPageGroup(){				//전체 페이지그룹 수
	...
	public int getNowPageGroup(){				//현재 페이지가 속한 그룹 번호 리턴
	...
	public int getStartPageOfPageGroup(){		//현재 페이지 그룹의 첫 페이지 번호
		int num=this.numberOfPageGroup*(this.getNowPageGroup()-1)+1;
		return num;
	}

	public int getEndPageOfPageGroup(){			//현재 페이지 그룹의 마지막 페이지 번호
	...
	public boolean isPreviousPageGroup(){		//현재 페이지 그룹의 전 페이지 그룹이 있나없나
		boolean flag=false;
	...
	public boolean isNextPageGroup(){			//현재 페이지 그룹의 다음 페이지 그룹이 있나없나
		boolean flag=false;
